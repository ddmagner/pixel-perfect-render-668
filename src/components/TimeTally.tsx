  ...
  return <div className="flex flex-col h-full w-full font-gilroy">
      ...
      <div className="px-5 pt-0.5 pb-1 h-[2.75rem]">
        {selection.hasAnySelected ? (
          <div className="flex items-center gap-2 bg-gray-50 w-full h-full py-2 pl-0 pr-3 justify-between rounded" style={{ boxShadow: '0 -4px 6px -1px rgba(0, 0, 0, 0.1), 0 -2px 4px -1px rgba(0, 0, 0, 0.06)' }}>
