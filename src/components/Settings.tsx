            ...
            <div className="w-12 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
              <div
                dangerouslySetInnerHTML={{
                  __html: `<svg width="24" height="24" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 24px; height: 24px; aspect-ratio: 1/1; fill: ${settings.accentColor};"> <path d="M5.75 0.5C8.78765 0.5 11.25 2.96235 11.25 6C11.25 9.03765 8.78765 11.5 5.75 11.5C4.8139 11.5 3.93225 11.2663 3.1606 10.8538L0.25 11.5L0.8968 8.5905C0.4843 7.8183 0.25 6.93665 0.25 6C0.25 2.96235 2.71235 0.5 5.75 0.5Z" fill="${settings.accentColor}"></path> </svg>`,
                }}
              />
            </div>
          </div>
