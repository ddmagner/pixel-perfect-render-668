        ...
        <div className="p-8" style={{ aspectRatio: '8.5/11', minHeight: '11in' }}>
          ...
          <div className="flex justify-between items-start mb-12">
            ...
            <div className="text-right">
              <div className="text-lg font-bold text-gray-900 mb-1">Invoice #001</div>
              <div className="text-lg text-gray-600">
          ...
          <div className="grid grid-cols-2 gap-12 mb-12">
            <div>
              <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wider mb-3">From</h3>
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wider mb-3">Bill To</h3>
              <div className="text-lg text-gray-700">
          ...
          <div className="mb-12">
            <div className="overflow-hidden">
              ...
              <div className="border-t border-b border-black">
                <div className="grid grid-cols-12 gap-4 px-6 py-2 text-lg font-bold text-gray-900 uppercase tracking-wider">
              ...
              <div className="divide-y divide-gray-200">
                {entries.map((entry, index) => {
                  ...
                  return (
                    <div key={index} className="grid grid-cols-12 gap-4 px-6 py-4 text-lg text-gray-700">
          ...
          <div className="flex justify-end mb-12">
            <div className="w-80">
              <div className="space-y-2">
                ...
                <div className="flex justify-between py-2 border-b border-gray-200">
                  <span className="text-lg text-gray-600">Tax (0%):</span>
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="grid grid-cols-2 gap-12">
              <div>
                <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wider mb-3">Payment Terms</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wider mb-3">Payment Methods</h3>
                <div className="text-lg text-gray-600 space-y-1">
          ...
          {/* Footer */}
          <div className="text-center text-lg text-gray-500 mt-12 pt-8 border-t border-gray-200">
