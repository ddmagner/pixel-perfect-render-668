      ...
      <div className="invoice-content mx-auto bg-white" style={{ padding: '0.75in 0.5in' }}>{/* Removed minHeight: '11in' to hug content */}
        ...
        <div className="mb-6">
          <div>
            ...
            <div className="text-black print-text" style={{ fontSize: '11px', lineHeight: '1.2' }}>Invoice #001</div>
            <div className="text-black print-text" style={{ fontSize: '11px', lineHeight: '1.2' }}>
        ...
        <div className="grid grid-cols-5 gap-6 mb-6">
          <div className="col-span-2">
            <h3 className="font-bold text-black print-text uppercase tracking-wider mb-1.5" style={{ fontSize: '11px', lineHeight: '1.2' }}>From</h3>
            <div className="text-black print-text" style={{ fontSize: '11px', lineHeight: '1.2' }}>
          ...
          <div className="col-span-3 -ml-[15px]">
            <h3 className="font-bold text-black print-text uppercase tracking-wider mb-1.5" style={{ fontSize: '11px', lineHeight: '1.2' }}>Bill To</h3>
            <div className="text-black print-text" style={{ fontSize: '11px', lineHeight: '1.2' }}>
                 {primaryClient ? (
                   <>
