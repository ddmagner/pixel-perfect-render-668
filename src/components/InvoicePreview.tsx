      ...
      <div className="bg-white w-full max-w-4xl h-full max-h-[90vh] overflow-auto rounded-lg shadow-2xl">
        ...
        <div className="px-[72px] py-8" style={{ aspectRatio: '8.5/11', minHeight: '11in' }}>
          ...
          <div className="flex justify-between items-start mb-12">
            <div>
              <h1 className="text-sm font-bold text-gray-900 mb-2">INVOICE</h1>
            ...
            <div className="text-right">
              <div className="text-sm font-bold text-gray-900 mb-1">Invoice #001</div>
              <div className="text-sm text-gray-600">
          ...
          <div className="mb-12">
            <div className="overflow-hidden">
              ...
              <div className="border-t border-b border-black">
                <div className="grid grid-cols-12 gap-4 pr-6 py-2 text-sm font-bold text-gray-900 uppercase tracking-wider">
