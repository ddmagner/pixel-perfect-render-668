...
export const RecordButton: React.FC<RecordButtonProps> = ({
  ...
  return <section className="flex w-full justify-center items-center gap-2.5 px-0 py-[50px]">
      <div className="flex flex-col items-center gap-10 shrink-0">
        ...
        <div className="flex items-center justify-center whitespace-nowrap w-full">
          ...
          <div className="flex items-center">
            ...
            <span className="text-[#09121F] text-[15px] italic font-black leading-[15px] tracking-[0.2px]">...for</span>
            <div dangerouslySetInnerHTML={{
