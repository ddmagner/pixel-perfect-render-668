...
export const Navigation: React.FC<NavigationProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <nav className={`flex justify-center items-center w-full max-w-sm mx-auto px-2.5 pt-4 pb-1 ${
...
export const TabNavigation: React.FC<TabNavigationProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <nav className={`flex items-start w-full max-w-sm mx-auto px-2.5 pt-0 pb-0 ${
      isArchivePage ? 'bg-gray-200 opacity-50 pointer-events-none' : 'bg-white'
    }`}>
      <button
