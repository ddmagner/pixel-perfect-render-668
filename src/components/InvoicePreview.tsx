        ...
        <div className="p-8" style={{ aspectRatio: '8.5/11', minHeight: '11in' }}>
          ...
          <div className="flex justify-between items-start mb-12">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-gray-900 mb-1">Invoice #001</div>
              <div className="text-gray-600">
          ...
          <div className="grid grid-cols-2 gap-12 mb-12">
            <div>
              <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-3">From</h3>
              <div className="text-gray-700">
                <p className="font-semibold text-lg">{settings.userProfile.name || 'Your Name'}</p>
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-3">Bill To</h3>
              <div className="text-gray-700">
          ...
          <div className="mb-12">
            <div className="overflow-hidden">
              ...
              <div className="border-t border-b border-black">
                <div className="grid grid-cols-12 gap-4 px-6 py-2 text-sm font-bold text-gray-900 uppercase tracking-wider">
              ...
              <div className="divide-y divide-gray-200">
                {entries.map((entry, index) => {
                  ...
                  return (
                    <div key={index} className="grid grid-cols-12 gap-4 px-6 py-4 text-sm text-gray-700">
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="grid grid-cols-2 gap-12">
              <div>
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-3">Payment Terms</h3>
              ...
              <div>
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-3">Payment Methods</h3>
                <div className="text-sm text-gray-600 space-y-1">
