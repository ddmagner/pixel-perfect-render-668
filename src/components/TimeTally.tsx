  ...
  return <div className="flex flex-col h-full w-full font-gilroy">
      ...
      <div className="px-5 pt-0.5 pb-1 h-[2.75rem]">
        {selection.hasAnySelected ? (
          <div className="fixed left-5 right-5 flex items-center gap-2 bg-gray-50 h-[2.75rem] py-2 pl-0 pr-3 justify-between rounded z-50" style={{ top: '180px', boxShadow: '0 -3px 8px -1px rgba(0, 0, 0, 0.2), 0 3px 8px -1px rgba(0, 0, 0, 0.2)' }}>
